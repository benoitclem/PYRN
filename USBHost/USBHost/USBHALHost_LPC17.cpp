...
static volatile uint8_t usb_buf[TOTAL_SIZE] __attribute((section("AHBSRAM0"),aligned(256)));  //256 bytes aligned!
...
void USBHALHost::init() {
	...
	//USB_INFO("Check For connected devices\n\r");
    if (LPC_USB->HcRhPortStatus1 & OR_RH_PORT_CCS) {
        //Device connected
        wait_ms(150);
        //USB_INFO("Device connected (%08x)\n\r", LPC_USB->HcRhPortStatus1);
